...
top.phentype.series <- g2d[!is.na(pheno_series_title), .(uq_prot = uniqueN(protein_id)), by = pheno_series_title][uq_prot >= 30 & uq_prot < 50]
...
top.phenotype <- g2d[!is.na(mim_title), .(uq_prot = uniqueN(protein_id)), by = mim_title][uq_prot >= 30 & uq_prot < 50]
